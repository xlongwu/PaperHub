...
export const WEB_SEARCH_CONNECTION_UI = {
  ...
  baseUrl: t("API 根地址", "API base URL"),
  apiKey: t("API 密钥", "API key"),
  authToken: t("本地认证 Token", "Local auth token"),
  command: t("启动命令", "Executable command"),
  arguments: t("命令参数（每行一个）", "Arguments (one per line)"),
  discoveredTools: t("发现的 Tools", "Discovered tools"),
  inputAdapter: t("输入 Adapter JSON", "Input adapter JSON"),
  invalidJson: t("Adapter 必须是合法 JSON 对象。", "Adapter must be a valid JSON object."),
  mcpEndpoint: t("HTTP MCP 地址", "HTTP MCP endpoint"),
  mcpTransport: t("MCP 传输方式", "MCP transport"),
  outputAdapter: t("输出 Adapter JSON", "Output adapter JSON"),
  toolName: t("搜索 Tool 名称", "Search tool name"),
  diagnostic: t("诊断", "Diagnostic"),
  retryable: t("可重试", "Retryable"),
  notRetryable: t("需修改配置", "Fix configuration first"),
